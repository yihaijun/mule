...
public class DubboJbpmSendActivity extends JpdlActivity implements EventListener
{
    ...
    private static final Log log = Log.getLog(DubboJbpmSendActivity.class.getName());
    ...
    {
        MessageService mule = EnvironmentImpl.getCurrent().get(DubboJbpmMessageService.class);
        if (mule == null)
        {
