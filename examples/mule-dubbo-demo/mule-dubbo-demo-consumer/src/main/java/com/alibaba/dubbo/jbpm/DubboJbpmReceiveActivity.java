...
public class DubboJbpmReceiveActivity extends StateActivity
{
    ...
    private static final Log log = Log.getLog(DubboJbpmReceiveActivity.class.getName());

    public DubboJbpmReceiveActivity(boolean startState)
    {
        super();
    ...
    throws Exception
    {
        ...
        if (endpoint != null)
        {
            String messageSource = null;//(String) execution.getVariable(Process.PROCESS_VARIABLE_INCOMING_SOURCE);
