 ...
 * @author yihaijun
 */
public class XalanCachingTransformerFactory {//extends TransformerFactoryImpl {
    /** Map to hold templates cache. */
    private static Map templatesCache = new HashMap();

    /** Factory logger. */
    protected static Logger logger = LoggerFactory.getLogger(XalanCachingTransformerFactory.class);
