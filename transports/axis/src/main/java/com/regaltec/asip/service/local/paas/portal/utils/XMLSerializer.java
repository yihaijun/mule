...
public class XMLSerializer
{
   ...
   public JSON read(String xml)
   {
      ...
      try
      {
         ...
         Document doc = new Builder().build(stringReader);
   ...
   public Element getXMLRootElement(JSON json)
   {
      Element root = null;
      ...
      else if (json instanceof JSONArray)
      {
         ...
         root = processJSONArray(jsonArray, newElement(getRootName() == null ? getArrayName() : getRootName()),
      ...
      else
      {
         ...
         {
            root = processJSONObject(jsonObject, newElement(getRootName() == null ? getObjectName() : getRootName()),
   ...
   public String writeXML(Element root, String encoding)
   {
   ...
   {
      Element root = this.getXMLRootElement(json);
      return this.writeXML(root, encoding);
   }
