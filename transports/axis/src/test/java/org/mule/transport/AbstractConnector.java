/*
 * $Id: AbstractConnector.java 22509 2011-07-21 18:25:43Z svacas $
 * --------------------------------------------------------------------------------------
...
//                        logger.warn("dispatchers.getMaxActive()="+dispatchers.getMaxActive()+"> 200,now setMaxActive(200).(getServiceDescriptor()="+getServiceDescriptor()+",phaseName="+phaseName+",name="+getName()+")");
//                        dispatchers.setMaxActive(200);
//                    }
//                    if(dispatchers.getMaxIdle() > 50){
//                        logger.warn("dispatchers.getMaxIdle()="+dispatchers.getMaxIdle()+"> 50,now setMaxIdle(50).(getServiceDescriptor()="+getServiceDescriptor()+",phaseName="+phaseName+",name="+getName()+")");
//                        dispatchers.setMaxIdle(50);
//                    }
//
//                    if(dispatchers.getMaxTotal() > 2000){
//                        logger.warn("dispatchers.getMaxTotal()="+dispatchers.getMaxTotal()+"> 2000,now setMaxTotal(2000).(getServiceDescriptor()="+getServiceDescriptor()+",phaseName="+phaseName+",name="+getName()+")");
//                        dispatchers.setMaxTotal(2000);
//                    }
//                    if(dispatchers.getNumActive()>10){
//                        logger.warn("dispatchers.getNumActive()="+dispatchers.getNumActive()+"> 10.(getServiceDescriptor()="+getServiceDescriptor()+",phaseName="+phaseName+",name="+getName()+")");
//                    }
   ...
   protected void configureDispatcherPool()
   {
    ...
    protected ScheduledExecutorService createScheduler()
    {
        ...
        ScheduledThreadPoolExecutor newExecutor = new ScheduledThreadPoolExecutor(10, threadFactory);
