...
public class HttpServerConnection
{
    ...
    private final int readRequestMsg = 1;
    private final int readResponseMsg = 2;
    ...
    public HttpRequest readRequest() throws IOException
    {
        try
        {
            String line = readLine(readRequestMsg);
            if (line == null)
            {
                return null;
            }
    ...
    public HttpResponse readResponse() throws IOException
    {
        try
        {
            String line = readLine(readResponseMsg);
    ...
    private String readLine(int msgType) throws IOException {
        String line = null;
