...
public  class SimpleUpdateSqlStatementStrategy implements SqlStatementStrategy
{
            ...
            ImmutableEndpoint endpoint, MuleEvent event,long timeout) throws Exception
    {
        ...
        try
        {
            ...
            //Add by yihaijun at 2012-04-23 
            //Package up result
            message = null;
            if (event != null)
            {
                message = new DefaultMuleMessage(new Integer(nbRows), event.getMessage(), connector.getMuleContext());
            }
            else
            {
                message = new DefaultMuleMessage(new Integer(nbRows), connector.getMuleContext());
            }
        ...
        //Delete by yihaijun at 2012-04-23 
