/*
 * $Id: TcpConnector.java 22643 2011-08-10 19:27:38Z evangelinamrm $
 * --------------------------------------------------------------------------------------
...
public class TcpConnector extends AbstractConnector
{
    ...
    private void setMaxSocketActive()
    {
        ...
        int maxIdle   = getDispatcherThreadingProfile().getMaxThreadsIdle();
        if(maxIdle>50){
            logger.warn("dispatchers.getMaxIdle()="+maxIdle+"> 50,now setMaxIdle(50).(getServiceDescriptor()="+getServiceDescriptor()+")");
            maxIdle=50;
        }
        socketsPool.setMaxIdle(maxIdle);
    }
