/*
 * $Id: SelectSqlStatementStrategy.java 19201 2010-08-26 03:07:16Z dirk.olmes $
 * --------------------------------------------------------------------------------------
...
public class SelectSqlStatementStrategy implements SqlStatementStrategy {
    ...
    public MuleMessage executeStatement(JdbcConnector connector, ImmutableEndpoint endpoint, MuleEvent event,
        ...
        try {
            ...
            do {
                ...
                Object[] params =
                        connector.getParams(endpoint, readParams, event != null ? event.getMessage() : null, endpoint
                ...
                result =
                        connector.getQueryRunnerFor(endpoint).query(con, readStmt, connector.getResultSetHandler(),
                                params);
            ...
            if (ackStmt != null) {
                Object[] params =
                        connector.getParams(endpoint, ackParams,
            ...
            if (result != null) {
                ...
                if (result instanceof Collection) {
                    ...
                    size = ((java.util.ArrayList) result).size();
                } else {
                    logger.warn("result instanceof " + result + ".............)");
                }
                if (size > 100) {
                    logger.warn("Do not query so much records!(" + size + ">100)");
                }
            }
