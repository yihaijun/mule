/*
 * $Id: HttpClientMessageDispatcher.java 24301 2012-04-19 08:54:57Z dirk.olmes $
 * --------------------------------------------------------------------------------------
...
public class HttpClientMessageDispatcher extends AbstractMessageDispatcher
{
    ...
    protected HttpMethod execute(MuleEvent event, HttpMethod httpMethod) throws Exception
    {
        ...
        try
        {
            ...
            if(httpMethod.getParams().getParameter(HttpMethodParams.MULTIPART_BOUNDARY) == null){
                httpMethod.getParams().setParameter(HttpMethodParams.MULTIPART_BOUNDARY, "asipBOUNDARYbkTYZNF_jY-9nzpN_UtLz3lxGR"); 
            }
