...
public class DefaultMuleClassPathConfig
{
    ...
    protected static final String LOCAL_DIR = "/lib/local";
    ...
    public DefaultMuleClassPathConfig(File muleHome, File muleBase)
    {
        try
        {
            ...
            {
                File localOverrideDir = new File(muleBase, LOCAL_DIR);
                this.addFile(localOverrideDir);
                this.addFiles(this.listJars(localOverrideDir));
            }
        }
        ...
        File localDir = new File(muleHome, LOCAL_DIR);
        this.addFile(localDir);
        this.addFiles(this.listJars(localDir));
