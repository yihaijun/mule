...
/**
 * If the specified <code>isbn</code> is not a valid ISBN13 code throw an exception.
 */
public class ValidateISBN13MessageProcessor extends AbstractValidationMessageProcessor
{

    /**
     * ISBN13 code to validate
     */
    private String isbn;
    ...
    protected Validator getValidator(MuleEvent event) throws Exception
    {
        ...
        return new Validator()
        {
            ...
            {
                return ISBNValidator.getInstance().isValidISBN13(evaluatedIsbn);
            }

            @Override
            public String getErrorMessage(MuleEvent event)
            {
                return String.format("%s is not a valid ISBN13 code", evaluatedIsbn);
            }
        };
    }
